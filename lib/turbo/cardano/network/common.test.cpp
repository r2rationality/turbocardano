...
suite cardano_network_suite = [] {
    "cardano::network::common"_test = [] {
        ...
        "segment_info"_test = [] {
            ...
            expect_equal(channel_mode::initiator, info.mode());
            expect_equal(mini_protocol::chain_sync, info.mini_protocol_id());
            expect_equal(12345, info.payload_size());
        };
