...
namespace turbo::cardano::ledger::pool_rank {
        ...
        const likelihood_prior prior={})
    {
        ...
        if (prior) {
            ...
            if (prior_lks.size() != lks.size()) [[unlikely]]
