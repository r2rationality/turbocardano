...
namespace turbo::cardano::ledger::shelley {
    ...
    protected:
        ...
        std::map<pool_hash, param_update> _ppups {};
        std::map<pool_hash, param_update> _ppups_future {};
...
namespace fmt {
    template<>
    struct formatter<turbo::cardano::ledger::shelley::vrf_state>: formatter<uint64_t> {
